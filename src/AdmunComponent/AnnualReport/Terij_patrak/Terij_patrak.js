...
import TerijPatrakModal from './TerijPatrakModal'
                  ...
                  <div className="body">
                    <div className="demo-masked-input">
                      <div className="row clearfix">
                        ...
                        <Button   type="button"  variant='primary' className="btn btn-block btn-lg waves-effect" data-toggle="modal" data-target="#exampleModal">Report</Button>
