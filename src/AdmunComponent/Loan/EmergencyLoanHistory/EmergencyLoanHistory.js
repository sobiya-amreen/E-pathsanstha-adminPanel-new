...
import EmergencyLoanHistoryDelete from './EmergencyLoanHistoryDeleteModal'
import EmergencyLoanHistoryEdit from './EmergencyLoanHistoryEditModal'
import { Button } from 'react-bootstrap'

const EmergencyLoanHistory = () => {
  return (
    <div>
              ...
              <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div className="card">
                  <div className="header">
                    <h2>Emergency Loan Trans History</h2>
                  </div>
                  <div className="body">
                        ...
                        >
                          ...
                          <tbody>
                            <tr role="row" className="odd">
                              ...
                              <td>Accountant</td>
                              <td>Accountant</td>
                              <td><EmergencyLoanHistoryDelete/></td>
                              <td><EmergencyLoanHistoryEdit/></td>
                            ...
                            <tr role="row" className="even">
                              ...
                              <td><i className='material-icons edit-icon'>border_color</i></td>
...
export default EmergencyLoanHistory
