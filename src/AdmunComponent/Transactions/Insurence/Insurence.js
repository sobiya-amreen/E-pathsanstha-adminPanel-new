                      ...
                      <Form onSubmit={handleSubmit(Submit)}>
                        ...
                        <div className="col-md-8">
                          ...
                          <div className="input-group">
                            ...
                            <div className="form-line">
                            <Form.Group className="mb-3" controlId="InsurancedateField">
                              <Form.Control
                                type="date"
                                className="form-control date"
                                {...register("Insurancedate",{required: "please enter Date"})}
                                
                              />
                                 </Form.Group>
                            </div>
                          </div>
                          <p style={{color:"red"}}>{errors?.Insurancedate?.message}</p>
                        </div>
                        ...
                        <div className="col-md-8">
                          ...
                          <div className="input-group">
                            ...
                            <div className="form-line">
                            <Form.Group className="mb-3" controlId="insuranceAmountField">
                              <Form.Control
                                type="number"
                                className="form-control date"
                                placeholder='Enter Insurance Amount'
                                {...register("insuranceAmount",{required: "please enter Insurance Amount"})}

                              />
                                 </Form.Group>
                            </div>
                          </div>
                          <p style={{color:"red"}}>{errors?.insuranceAmount?.message}</p>
                        </div>
