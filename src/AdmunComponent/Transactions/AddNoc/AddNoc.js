...
import AddNocDeleteModal from './AddNocDeleteModal'
              ...
              <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div className="card">
                  <div className="header">
                    <h2>Regular Loan & Emergency Loan Completed Certificate</h2>
                  </div>
                  <div className="body">
                    <div className="demo-masked-input">
                      <div className="row clearfix">
                          ...
                          <div className="input-group">
                            ...
                            <div className="form-line">
                              <input
                                ...
                                placeholder="By Account Number / Name"
                              />
                              <button type="button" className="btn bg-indigo btn-block btn-lg waves-effect primaryButton secondaryButton">Submit</button>
                            </div>
                          </div>
                        </div>
                        ...
                        <Button type="submit"  variant='primary' className="btn btn-block btn-lg waves-effect">Cancel</Button>
